  ...
  const fetchData = async () => {
    try {
      const { data } = await axios.get(
        "https://mr-arsad-new-gps-backend.vercel.app/api/v1/planes/all"
      );
      setData(data);
    } catch (err) {
      console.log(err);
    ...
    const postHandler = async (e) => {
      ...
      try {
        const data = await axios.post(
          "https://mr-arsad-new-gps-backend.vercel.app/api/v1/planes",
          { time, plane }
        );
        console.log(data);
        fetchData();
    ...
    const putHandler = async (e) => {
      ...
      try {
        const data = await axios.put(
          `https://mr-arsad-new-gps-backend.vercel.app/api/v1/planes/update/${id}`,
          { time, plane }
        );
        console.log(data);
        fetchData();
  ...
  const deleteHandler = async (id) => {
    try {
      const data = await axios.delete(
        `https://mr-arsad-new-gps-backend.vercel.app/api/v1/planes/delete/${id}`
      );
      console.log(data);
