  ...
  const fetchData = useCallback(async () => {
    try {
      const { data } = await axios.get(
        "https://mr-arsad-new-gps-backend.vercel.app/api/v1/ride/all"
      );
      setData(data);
    } catch (err) {
      console.log(err);
    ...
    const postHandler = async (e) => {
      ...
      try {
        const data = await axios.post(
          "https://mr-arsad-new-gps-backend.vercel.app/api/v1/ride/",
          {
            rideType,
            time,
            distance,
    ...
    const putHandler = async (e) => {
      ...
      try {
        const data = await axios.put(
          `https://mr-arsad-new-gps-backend.vercel.app/api/v1/ride/${id}`,
          {
            rideType,
            time,
            distance,
