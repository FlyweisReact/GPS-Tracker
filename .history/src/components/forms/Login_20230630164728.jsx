...
const Login = () => {
  ...
  return (
    <>
      <div className="w-full h-screen flex flex-col justify-center items-center bg-slate-100" style={{backgroundColor : "rgb(25, 55, 109)"}}>
        <Form
        ...
        >
          ...
          <section className="py-7 space-y-6">
            ...
            <button
              type="submit"
              className="py-2 cursor-pointer tracking-wider bg-[rgb(25, 55, 109)] flex justify-center items-center w-full rounded-md font-medium   "
            >
              {loading ? (
